...
<?php include "partials/nav.php" ?>
    ...
    <section class="home-slider owl-carousel js-fullheight bg-dark">
        ...
        <div class="container">
          <div class="row slider-text js-fullheight justify-content-center align-items-center" data-scrollax-parent="true">
            ...
            <div class="col-md-12 col-sm-12 text-center ftco-animate">
              <h1 class="mb-4 mt-5">PALACER</h1>
              <h2>el Palacio del Placer</h2>
              <p><a href="#chefs" class="btn btn-white btn-outline-white p-3 px-xl-4 py-xl-3">Our team</a></p>
            </div>
      ...
      <div class="slider-item js-fullheight" style="background-image: url(images/bg_3.jpg);">
		...
		<section class="ftco-section ftco-wrap-about ftco-no-pb">
			<div class="container">
	          ...
	          <div class="heading-section mb-4 text-center">
	            ...
	            <h2 class="mb-4">Restaurante Palacer</h2>
	          </div>
						<p>On her way she met a copy. The copy warned the Little Blind Text, that where it came from it would have been rewritten a thousand times and everything that was left from its origin would be the word "and" and the Little Blind Text should turn around and return to its own, safe country. A small river named Duden flows by their place and supplies it with the necessary regelialia. It is a paradisematic country, in which roasted parts of sentences fly into your mouth.</p>

						<div class="video justify-content-center">
							<a href="https://vimeo.com/294745408" class="icon-video popup-vimeo d-flex justify-content-center align-items-center">
		...
		<section class="ftco-section" id="chefs">
			<div class="container">
				<div class="row justify-content-center mb-5 pb-2">
          <div class="col-md-7 text-center heading-section ftco-animate">
